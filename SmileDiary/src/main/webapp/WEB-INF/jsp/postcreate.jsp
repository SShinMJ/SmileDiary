            ...
            <div class="page" id="both_page">
                ...
                <form class="form-horizontal"
                    ...
                    <div>
                        ...
                        <button type="button" class="btn btn-default" value="파일 추가"  onclick="popup()">파일 추가</button>
                    </div>
                    <button type="submit" id="submit">저장</button>
                    <button type="button" id="board_btn" onclick="location.href='/board/listpage'">목록</button>
                </form>
            </div>
            <div id="category">
