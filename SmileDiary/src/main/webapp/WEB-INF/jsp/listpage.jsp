        ...
        <div id="diary">
            ...
            <div class="page" id="both_page">
                <div style="margin: 10px">
                    <h2>게시판</h2>
                    <button type="button" id="writeBtn" class="btn btn-default" onclick="location.href='/postcreate'">글
                        등록
                    </button>
                    <br>
                    <label for="search_keyword"></label>
                    <input type="text" id="search_keyword" name="search_keyword">
                    <button type="button" id="search" name="search" class="btn btn-default">검색</button>
                </div>
                ...
                <ul class="pagination">
                    <c:if test="${pageMaker.prev}">
                        <li>
                            <a href="/board/listpage${pageMaker.makeQuery(pageMaker.start_page - 1)}">[이전]</a>
                        </li>
                    </c:if>
                    ...
                    <c:if test="${pageMaker.next }">
                        <li>
                            <a href="/board/listpage${pageMaker.makeQuery(pageMaker.end_page + 1)}">[다음]</a>
                        </li>
                    </c:if>
                </ul>
            </div>
